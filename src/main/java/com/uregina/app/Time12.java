...
public class Time12 {
	...
	/**
	 * calculates the minutes of subracting two valid Time12 objects assuming that
	 * both times happened in the same day.
	 * 
	 * @param t1 12-hour time object
	 * @param t1 12-hour time object
	 * @return minutes equivalent of calculating (t1-t2) which can be positive, zero
	 *         or negative integer usefeul functions that you may use (class: Time12
	 *         , method: toTime24) (class: Time24 , method: getHours) (class: Time24
	 *         , method: getMinutes)
	 */
	public static int subtract(Time12 t1, Time12 t2) {
		...
		int foundHours1 = t1.hours * 60;
		int foundHours2 = t2.hours * 60;

		int totalfoundminutes1 = foundHours1 + t1.minutes;
		int totalfoundminutes2 = foundHours2 + t2.minutes;

		difference = (totalfoundminutes2 - totalfoundminutes1);
		// end of your code
		return difference = (totalfoundminutes2 - totalfoundminutes1);
