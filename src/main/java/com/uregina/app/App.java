...
public class App 
{
	 ...
	 */
    public static void main( String[] args ) throws MoreThanOneDayException, NegativeTimeException, InvalidTimeException
    {
		...
		for(Flight f : ticket)
		{
			System.out.println( "\tFrom: "+Flight.getDepatureAirport()+" [ "+
				Flight.getDepatureTime()+"] to "+Flight.getArrivalAirport()+" [ "+
